...
int main()
{
    unsigned char source_file_name[FILE_NAME_LENGTH];
    ...
    strcpy(source_file_name, "input_resources/encrypt.txt");
    ...
    strcpy(source_file_name, "input_resources/pattern_matching.txt");
